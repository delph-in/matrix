...
(described in \citeboth{Wahl:Karg:00})
...
given in the hierarchy in Figure~\ref{msgfig}, all of which carry the suffix
...
For a fuller discussion of these issues, see \citeboth{Cop:Fli:Sag:Pol:03}.
...
This paper is an extension of work first reported in \citeboth{Fli:Ben:03}.
