...
((:path . "adnom-poss-spec-dep-aff-two-strat-order-var") (:content . "adnom-poss-spec-dep-aff-two-strat-order-var: Two poss strategies, both dep affixally marked, one head-final, one head initial"))
((:path . "adnom-poss-dep-aff-two-strat-mod-spec-var") (:content . "adnom-poss-dep-aff-two-strat-mod-spec-var: Two poss strategies, both dep affixally marked, one mod-like, one spec-like"))
((:path . "adnom-poss-spec-head-non-aff-hf-agr") (:content . "adnom-poss-spec-head-non-aff-hf-agr: Head non-affixally marked, agreeing, head final poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-head-non-aff-hf") (:content . "adnom-poss-spec-head-non-aff-hf: Head non-affixally marked, head final poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-head-aff-hf-agr") (:content . "adnom-poss-spec-head-aff-hf-agr: Head affixally marked agreeing, head final poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-head-aff-free-wo") (:content . "adnom-poss-spec-head-aff-free-wo: Head affixally marked, free wo poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-head-aff-hf") (:content . "adnom-poss-spec-head-aff-hf: Head affixally marked, head final poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-non-aff-head-non-aff-hf-agr-head") (:content . "adnom-poss-spec-dep-non-aff-head-non-aff-hf-agr-head: Dep and head non-affixally marked, head agreeing, head final poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-non-aff-head-non-aff-hf-agr-dep") (:content . "adnom-poss-spec-dep-non-aff-head-non-aff-hf-agr-dep: Dep and head non-affixally marked, dep agreeing, head final poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-non-aff-head-non-aff-hf-agr-mut") (:content . "adnom-poss-spec-dep-non-aff-head-non-aff-hf-agr-mut: Dep and head non-affixally marked, both agreeing, head final poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-non-aff-head-non-aff-free-wo") (:content . "adnom-poss-spec-dep-non-aff-head-non-aff-free-wo: Dep and head non-affixally marked, free-wo poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-non-aff-head-non-aff-hf") (:content . "adnom-poss-spec-dep-non-aff-head-non-aff-hf: Dep and head non-affixally marked, head final poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-non-aff-head-aff-hf-agr-head") (:content . "adnom-poss-spec-dep-non-aff-head-aff-hf-agr-head: Dep non-affixally marked, head affixally, head agreeing, head final poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-non-aff-head-aff-hf-agr-dep") (:content . "adnom-poss-spec-dep-non-aff-head-aff-hf-agr-dep: Dep non-affixally marked, head affixally, dep agreeing, head final poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-non-aff-head-aff-hf-agr-mut") (:content . "adnom-poss-spec-dep-non-aff-head-aff-hf-agr-mut: Dep non-affixally marked, head affixally, both agreeing, head final poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-non-aff-head-aff-free-wo") (:content . "adnom-poss-spec-dep-non-aff-head-aff-free-wo: Dep non-affixally marked, head affixally, free wo poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-non-aff-head-aff-hf") (:content . "adnom-poss-spec-dep-non-aff-head-aff-hf: Dep non-affixally marked, head affixally, free wo poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-non-aff-hf-agr") (:content . "adnom-poss-spec-dep-non-aff-hf-agr: Dep non-affixally marked, agreeing, head final poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-non-aff-free-wo") (:content . "adnom-poss-spec-dep-non-aff-free-wo: Dep non-affixally marked free-wo poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-non-aff-hf") (:content . "adnom-poss-spec-dep-non-aff-hf: Dep non-affixally marked head final poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-aff-head-non-aff-hf-agr-head") (:content . "adnom-poss-spec-dep-aff-head-non-aff-hf-agr-head: Dep affixally marked, head non-affixally, dead agreeing, head final poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-aff-head-non-aff-hf-agr-dep") (:content . "adnom-poss-spec-dep-aff-head-non-aff-hf-agr-dep: Dep affixally marked, head non-affixally, dep agreeing, head final poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-aff-head-non-aff-hf-agr-mut") (:content . "adnom-poss-spec-dep-aff-head-non-aff-hf-agr-mut: Dep affixally marked, head non-affixally, both agreeing, head final poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-aff-head-non-aff-hf") (:content . "adnom-poss-spec-dep-aff-head-non-aff-hf: Dep affixally marked, head non-affixally, head final poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-aff-head-aff-hf-agr-head") (:content . "adnom-poss-spec-dep-aff-head-aff-hf-agr-head: Dep and head affixally marked, dep agreeing head final poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-aff-head-aff-hf-agr-dep") (:content . "adnom-poss-spec-dep-aff-head-aff-hf-agr-dep: Dep and head affixally marked, dep agreeing head final poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-aff-head-aff-hf-agr-mut") (:content . "adnom-poss-spec-dep-aff-head-aff-hf-agr-mut: Dep and head affixally marked, both agreeing, head final poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-aff-head-aff-hf") (:content . "adnom-poss-spec-dep-aff-head-aff-hf: Dep and head affixally marked head final poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-aff-hi") (:content . "adnom-poss-spec-dep-aff-hi: Dep affixally marked head initial poss construction w spec-like attachment"))
((:path . "adnom-poss-spec-dep-aff-hf-pron-agr") (:content . "adnom-poss-spec-dep-aff-hf-pron-agr: Dep affixally marked head final poss construction w spec-like attachment, with similar agreeing pronouns"))
((:path . "adnom-poss-spec-dep-aff-hf-pron-aff") (:content . "adnom-poss-spec-dep-aff-hf-pron-aff: Dep affixally marked head final poss construction w spec-like attachment, with affixal pronouns"))
((:path . "adnom-poss-spec-dep-aff-hf-pron") (:content . "adnom-poss-spec-dep-aff-hf-pron: Dep affixally marked head final poss construction w spec-like attachment, with similar pronouns"))
((:path . "adnom-poss-spec-dep-aff-hf-agr") (:content . "adnom-poss-spec-dep-aff-hf-agr: Dep affixally marked agreeing head final poss construction w spec-like attachment"))
...
((:path . "adnom-poss-mod-head-aff-free-wo") (:content . "adnom-poss-mod-head-aff-free-wo: Head marked free wo poss construction w mod-like attachment"))
((:path . "adnom-poss-mod-head-aff-hi") (:content . "adnom-poss-mod-head-aff-hi: Head marked head inital poss construction w mod-like attachment"))
((:path . "adnom-poss-mod-head-aff-hf") (:content . "adnom-poss-mod-head-aff-hf: Head marked head final poss construction w mod-like attachment"))
((:path . "adnom-poss-mod-dep-non-aff-head-aff-hi-sov") (:content . "adnom-poss-mod-dep-non-aff-head-aff-hi-sov: Dep non-affixally marked, head affixally marked head initial poss construction w mod-like attachment, general wo is head final"))
((:path . "adnom-poss-mod-dep-non-aff-head-aff-hf-sov") (:content . "adnom-poss-mod-dep-non-aff-head-aff-hf-sov: Dep non-affixally marked, head affixally marked head final poss construction w mod-like attachment, general wo is head final"))
((:path . "adnom-poss-mod-dep-non-aff-head-aff-hf-agr-head") (:content . "adnom-poss-mod-dep-non-aff-head-aff-hf-agr-head: Dep non-affixally marked, head affixally marked, head agreeing head final poss construction w mod-like attachment"))
((:path . "adnom-poss-mod-dep-non-aff-head-aff-hf-agr-dep") (:content . "adnom-poss-mod-dep-non-aff-head-aff-hf-agr-dep: Dep non-affixally marked, head affixally marked, dep agreeing head final poss construction w mod-like attachment"))
((:path . "adnom-poss-mod-dep-non-aff-head-aff-hf-agr-mut") (:content . "adnom-poss-mod-dep-non-aff-head-aff-hf-agr-mut: Dep non-affixally marked, head affixally marked, both agreeing head final poss construction w mod-like attachment"))
((:path . "adnom-poss-mod-dep-non-aff-head-aff-hf") (:content . "adnom-poss-mod-dep-non-aff-head-aff-hf: Dep non-affixally marked, head affixally marked head final poss construction w mod-like attachment"))
((:path . "adnom-poss-mod-dep-non-aff-head-aff-free-wo") (:content . "adnom-poss-mod-dep-non-aff-head-aff-free-wo: Dep non-affixally marked, head affixally marked free wo poss construction w mod-like attachment"))
((:path . "adnom-poss-mod-dep-non-aff-hi") (:content . "adnom-poss-mod-dep-non-aff-hi: Dep non-affixally marked head final poss construction w mod-like attachment"))
((:path . "adnom-poss-mod-dep-non-aff-hf-agr") (:content . "adnom-poss-mod-dep-non-aff-hf-agr: Dep non-affixally marked head final poss construction w mod-like attachment"))
((:path . "adnom-poss-mod-dep-non-aff-free-wo") (:content . "adnom-poss-mod-dep-non-aff-free-wo: Dep non-affixally marked free wo poss construction w mod-like attachment"))
((:path . "adnom-poss-mod-dep-non-aff-hf") (:content . "adnom-poss-mod-dep-non-aff-hf: Dep non-affixally marked head final poss construction w mod-like attachment"))
((:path . "adnom-poss-mod-dep-aff-head-aff-hf-agr-head") (:content . "adnom-poss-mod-dep-aff-head-aff-hf-agr-head: Dep and head affixally marked, head agreeing head initial poss construction w mod-like attachment"))
((:path . "adnom-poss-mod-dep-aff-head-aff-hf-agr-dep") (:content . "adnom-poss-mod-dep-aff-head-aff-hf-agr-dep: Dep and head affixally marked, dep agreeing head initial poss construction w mod-like attachment"))
((:path . "adnom-poss-mod-dep-aff-head-aff-hf-agr-mut") (:content . "adnom-poss-mod-dep-aff-head-aff-hf-agr-mut: "))
((:path . "adnom-poss-mod-dep-aff-head-aff-hi") (:content . "adnom-poss-mod-dep-aff-head-aff-hi: Dep and head affixally marked head initial poss construction w mod-like attachment"))
((:path . "adnom-poss-mod-dep-aff-head-aff-hf") (:content . "adnom-poss-mod-dep-aff-head-aff-hf: Dep and head affixally marked head final poss construction w mod-like attachment"))
((:path . "adnom-poss-mod-dep-aff-hi") (:content . "adnom-poss-mod-dep-aff-hi: Dep affixally marked head initial poss construction w mod-like attachment"))
((:path . "adnom-poss-mod-dep-aff-hf-pron-agr") (:content . "adnom-poss-mod-dep-aff-hf-pron-agr: Dep affixally marked head final poss construction w mod-like attachment, and similar agreeingposs pronouns"))
((:path . "adnom-poss-mod-dep-aff-hf-pron-aff-mod") (:content . "adnom-poss-mod-dep-aff-hf-pron-aff-mod: Dep affixally marked head final poss construction w mod-like attachment, and poss pron affixes that are mod-like"))
((:path . "adnom-poss-mod-dep-aff-hf-pron-aff-agr") (:content . "adnom-poss-mod-dep-aff-hf-pron-aff-agr: Dep affixally marked head final poss construction w mod-like attachment, and agreement poss pron affixes"))
((:path . "adnom-poss-mod-dep-aff-hf-pron") (:content . "adnom-poss-mod-dep-aff-hf-pron: Dep affixally marked head final poss construction w mod-like attachment, and similar poss pronouns"))
((:path . "adnom-poss-mod-dep-aff-hf-agr") (:content . "adnom-poss-mod-dep-aff-hf-agr: Dep affixaly marked agreement head final poss construction w mod-like attachment"))
((:path . "adnom-poss-mod-dep-aff-free-wo") (:content . "adnom-poss-mod-dep-aff-free-wo: Dep marked free wo poss construction w mod-like attachment"))
((:path . "adnom-poss-mod-dep-aff-hf") (:content . "adnom-poss-mod-dep-aff-hf: Dep marked head final poss construction w mod-like attachment"))
((:path . "adnom-poss-mod-juxt") (:content . "adnom-poss-mod-juxt: Juxtaposition poss construction w mod-like attachment"))
((:path . "adnom-poss-mod-possessum-affix-bidirec") (:content . "adnom-poss-mod-possessum-affix-bidirec: dummy comment"))
((:path . "adnom-poss-mod-possessor-non-affix-possessum-affix-bidirec") (:content . "adnom-poss-mod-possessor-non-affix-possessum-affix-bidirec: dummy comment"))
((:path . "adnom-poss-mod-possessor-non-affix-bidirec") (:content . "adnom-poss-mod-possessor-non-affix-bidirec: dummy comment"))
((:path . "adnom-poss-mod-possessor-affix-bidirec") (:content . "adnom-poss-mod-possessor-affix-bidirec: dummy comment"))
((:path . "adnom-poss-spec-possessum-affix-bidirec") (:content . "adnom-poss-spec-possessum-affix-bidirec: dummy comment"))
((:path . "adnom-poss-spec-possessor-non-affix-possessum-non-affix-bidirec") (:content . "adnom-poss-spec-possessor-non-affix-possessum-non-affix-bidirec: dummy comment"))
((:path . "adnom-poss-spec-possessor-non-affix-possessum-affix-bidirec") (:content . "adnom-poss-spec-possessor-non-affix-possessum-affix-bidirec: dummy comment"))
((:path . "adnom-poss-spec-possessor-non-affix-bidirec") (:content . "adnom-poss-spec-possessor-non-affix-bidirec: dummy comment"))
((:path . "adnom-poss-spec-possessor-affix-bidirec") (:content . "adnom-poss-spec-possessor-affix-bidirec: dummy comment"))
((:path . "adnom-poss-mod-possessum-affix-head-initial") (:content . "adnom-poss-mod-possessum-affix-head-initial: dummy comment"))
((:path . "adnom-poss-mod-possessor-affix-possessum-affix-head-initial") (:content . "adnom-poss-mod-possessor-affix-possessum-affix-head-initial: dummy comment"))
((:path . "adnom-poss-mod-juxt") (:content . "adnom-poss-mod-juxt: modifier-like juxtaposition"))
((:path . "adnom-poss-spec-possessor-affix-possessum-non-affix-head-final") (:content . "adnom-poss-spec-possessor-affix-possessum-non-affix-head-final: dummy comment"))
((:path . "adnom-poss-mod-possessor-non-affix-possessum-affix-head-final") (:content . "adnom-poss-mod-possessor-non-affix-possessum-affix-head-final: dummy comment"))
((:path . "adnom-poss-mod-possessor-non-affix-possessum-affix-head-initial-sov-right-side-marker") (:content . "adnom-poss-mod-possessor-non-affix-possessum-affix-head-initial-sov-right-side-marker: test for word order combo poss phrase doesn't match normal head-comp"))
((:path . "adnom-poss-spec-possessor-affix-head-final-pron") (:content . "adnom-poss-spec-possessor-affix-head-final-pron: pron spec"))
((:path . "adnom-poss-mod-possessor-affix-head-final-pron") (:content . "adnom-poss-mod-possessor-affix-head-final-pron: pronoun, mod-like"))
((:path . "adnom-poss-spec-possessor-affix-two-strat-mod-spec-var") (:content . "adnom-poss-spec-possessor-affix-two-strat-mod-spec-var: two strategies, one spec one mod"))
((:path . "adnom-poss-spec-possessor-affix-two-strat-order-var") (:content . "adnom-poss-spec-possessor-affix-two-strat-order-var: two strategies, identical except for order"))
((:path . "adnom-poss-spec-possessor-non-affix-possessum-non-affix-head-final") (:content . "adnom-poss-spec-possessor-non-affix-possessum-non-affix-head-final: spec, both non-affix, head final, no agr"))
((:path . "adnom-poss-spec-possessum-non-affix-head-final-agr") (:content . "adnom-poss-spec-possessum-non-affix-head-final-agr: spec, possessum non-affix, head-final, agr"))
((:path . "adnom-poss-spec-possessum-non-affix-head-final") (:content . "adnom-poss-spec-possessum-non-affix-head-final: spec, possessum non-affix, head-final, agr"))
((:path . "adnom-poss-spec-possessum-affix-head-final-agr") (:content . "adnom-poss-spec-possessum-affix-head-final-agr: spec, possessum-affix, head-final, agr"))
((:path . "adnom-poss-spec-possessum-affix-head-final") (:content . "adnom-poss-spec-possessum-affix-head-final: spec, possessum affix, head final, no agr"))
((:path . "adnom-poss-spec-possessor-affix-head-final-pron-affix") (:content . "adnom-poss-spec-possessor-affix-head-final-pron-affix: pronoun is affix, takes no det"))
((:path . "adnom-poss-mod-possessor-affix-head-final-pron-affix-agr") (:content . "adnom-poss-mod-possessor-affix-head-final-pron-affix-agr: pronoun affix with agreement"))
((:path . "adnom-poss-mod-possessor-affix-head-final-pron-affix-mod") (:content . "adnom-poss-mod-possessor-affix-head-final-pron-affix-mod: pronoun affix that takes a det"))
((:path . "adnom-poss-spec-juxt") (:content . "adnom-poss-spec-juxt: spec-like juxtaposition"))
((:path . "adnom-poss-spec-possessor-affix-head-final-pron-agr") (:content . "adnom-poss-spec-possessor-affix-head-final-pron-agr: pronoun is separate word with agreement"))
((:path . "adnom-poss-mod-possessor-affix-head-final-pron-agr") (:content . "adnom-poss-mod-possessor-affix-head-final-pron-agr: pronouns as separate words with agr"))
((:path . "adnom-poss-spec-possessor-non-affix-possessum-non-affix-head-final-agr-unidir-possessum") (:content . "adnom-poss-spec-possessor-non-affix-possessum-non-affix-head-final-agr-unidir-possessum: spec, both non-affix, head-final, possessum agrees"))
((:path . "adnom-poss-spec-possessor-non-affix-possessum-non-affix-head-final-agr-unidir-possessor") (:content . "adnom-poss-spec-possessor-non-affix-possessum-non-affix-head-final-agr-unidir-possessor: spec, both non-affix, head-final, possessor agrees"))
((:path . "adnom-poss-spec-possessor-non-affix-possessum-non-affix-head-final-agr-mutual") (:content . "adnom-poss-spec-possessor-non-affix-possessum-non-affix-head-final-agr-mutual: spec, both non-affix, head-final, mutual agr"))
((:path . "adnom-poss-spec-possessor-non-affix-possessum-affix-head-final-agr-unidir-possessum") (:content . "adnom-poss-spec-possessor-non-affix-possessum-affix-head-final-agr-unidir-possessum: spec, possessor non-affix possessum affix, head-final, possessum agrees"))
((:path . "adnom-poss-spec-possessor-non-affix-possessum-affix-head-final-agr-unidir-possessor") (:content . "adnom-poss-spec-possessor-non-affix-possessum-affix-head-final-agr-unidir-possessor: spec, possessor non-affix, possessum affix, head-final, possessor agrees"))
((:path . "adnom-poss-spec-possessor-non-affix-possessum-affix-head-final-agr-mutual") (:content . "adnom-poss-spec-possessor-non-affix-possessum-affix-head-final-agr-mutual: spec, possessor non-affix, possessum affix, head-final, mutual agr"))
((:path . "adnom-poss-spec-possessor-non-affix-possessum-affix-head-final") (:content . "adnom-poss-spec-possessor-non-affix-possessum-affix-head-final: spec, possessor-non-affix, possessum- affix, head-final, no agr"))
((:path . "adnom-poss-spec-possessor-non-affix-head-final-agr") (:content . "adnom-poss-spec-possessor-non-affix-head-final-agr: spec, possessor-nonaffix, head-final, agr"))
((:path . "adnom-poss-spec-possessor-non-affix-head-final") (:content . "adnom-poss-spec-possessor-non-affix-head-final: spec, possessor non-affix, head-final"))
((:path . "adnom-poss-spec-possessor-affix-possessum-non-affix-head-final-agr-unidir-possessum") (:content . "adnom-poss-spec-possessor-affix-possessum-non-affix-head-final-agr-unidir-possessum: spec, possessor affix, possessum non-affix, head-final, possessum agrees"))
((:path . "adnom-poss-spec-possessor-affix-possessum-non-affix-head-final-agr-unidir-possessor") (:content . "adnom-poss-spec-possessor-affix-possessum-non-affix-head-final-agr-unidir-possessor: spec, possessor affix, possessum non-affix, head-final, possessor agrees"))
((:path . "adnom-poss-spec-possessor-affix-possessum-non-affix-head-final-agr-mutual") (:content . "adnom-poss-spec-possessor-affix-possessum-non-affix-head-final-agr-mutual: spec, possessor affix, possessum non-affix, head-final, mutual agr"))
((:path . "adnom-poss-spec-possessor-affix-possessum-affix-head-final-agr-unidir-possessum") (:content . "adnom-poss-spec-possessor-affix-possessum-affix-head-final-agr-unidir-possessum: spec, both affixes, head-final, possessum agrees"))
((:path . "adnom-poss-spec-possessor-affix-possessum-affix-head-final-agr-unidir-possessor") (:content . "adnom-poss-spec-possessor-affix-possessum-affix-head-final-agr-unidir-possessor: spec, both affixes, head-final, possessor agrees"))
((:path . "adnom-poss-spec-possessor-affix-possessum-affix-head-final-agr-mutual") (:content . "adnom-poss-spec-possessor-affix-possessum-affix-head-final-agr-mutual: spec, both affixes, head-final, mutual agr"))
((:path . "adnom-poss-spec-possessor-affix-possessum-affix-head-final") (:content . "adnom-poss-spec-possessor-affix-possessum-affix-head-final: spec, possessor affix, possessum affix, head-final, no agr"))
((:path . "adnom-poss-spec-possessor-affix-head-initial") (:content . "adnom-poss-spec-possessor-affix-head-initial: spec, possessor-affix, head-initial"))
((:path . "adnom-poss-spec-possessor-affix-head-final-agr") (:content . "adnom-poss-spec-possessor-affix-head-final-agr: spec, possessor affix, head-final, with agr"))
((:path . "adnom-poss-spec-possessor-affix-head-final") (:content . "adnom-poss-spec-possessor-affix-head-final: spec, possessor affix, head-final, no agr"))
((:path . "adnom-poss-mod-possessum-affix-head-final-agr") (:content . "adnom-poss-mod-possessum-affix-head-final-agr: mod, possessum affix, head-final, no agr"))
((:path . "adnom-poss-mod-possessum-affix-head-final") (:content . "adnom-poss-mod-possessum-affix-head-final: mod, possessum affix, head-final, no agr"))
((:path . "adnom-poss-mod-possessor-non-affix-possessum-affix-head-final-sov-right-side-marker") (:content . "adnom-poss-mod-possessor-non-affix-possessum-affix-head-final-sov-right-side-marker: mod, possessor no-affix, possessum affix, various word orders"))
((:path . "adnom-poss-mod-possessor-non-affix-possessum-affix-head-final-agr-unidir-possessum") (:content . "adnom-poss-mod-possessor-non-affix-possessum-affix-head-final-agr-unidir-possessum: mod, possessor non-affix, possessum affix, head-final, possessum agrees"))
((:path . "adnom-poss-mod-possessor-non-affix-possessum-affix-head-final-agr-unidir-possessor") (:content . "adnom-poss-mod-possessor-non-affix-possessum-affix-head-final-agr-unidir-possessor: mod, possessor nonaffix, possessum affix, head-final, possessor agrees"))
((:path . "adnom-poss-mod-possessor-non-affix-possessum-affix-head-final-agr-mutual") (:content . "adnom-poss-mod-possessor-non-affix-possessum-affix-head-final-agr-mutual: mod, popossessum marked, possessum affix, head-final, mutual agr"))
((:path . "adnom-poss-mod-possessor-non-affix-head-initial") (:content . "adnom-poss-mod-possessor-non-affix-head-initial: mod, possessor non-affix, head-initial, no agr"))
((:path . "adnom-poss-mod-possessor-non-affix-head-final-agr") (:content . "adnom-poss-mod-possessor-non-affix-head-final-agr: mod, possessor non-affix, head-final, agr"))
((:path . "adnom-poss-mod-possessor-non-affix-head-final") (:content . "adnom-poss-mod-possessor-non-affix-head-final: mod, possessor nonaffix, head-final, no agr"))
((:path . "adnom-poss-mod-possessor-affix-possessum-affix-head-final-agr-unidir-possessum") (:content . "adnom-poss-mod-possessor-affix-possessum-affix-head-final-agr-unidir-possessum: mod-like, possessor and possessum affix, head-final, possessum agrees"))
((:path . "adnom-poss-mod-possessor-affix-possessum-affix-head-final-agr-unidir-possessor") (:content . "adnom-poss-mod-possessor-affix-possessum-affix-head-final-agr-unidir-possessor: mod-like, possessor and possessum afix, head-final, possessor agrees"))
((:path . "adnom-poss-mod-possessor-affix-possessum-affix-head-final-agr-mutual") (:content . "adnom-poss-mod-possessor-affix-possessum-affix-head-final-agr-mutual: mod-like, possessor and possessum affix, head-final, mutual agr"))
((:path . "adnom-poss-mod-possessor-affix-possessum-affix-head-final") (:content . "adnom-poss-mod-possessor-affix-possessum-affix-head-final: possessor and possessum affix, mod-like, head-final, no agr"))
((:path . "adnom-poss-mod-possessor-affix-head-initial") (:content . "adnom-poss-mod-possessor-affix-head-initial: mod-like, possessor affix, head-initial, no agr"))
((:path . "adnom-poss-mod-possessor-affix-head-final") (:content . "adnom-poss-mod-possessor-affix-head-final: mod, possessor affix, head-final, no agr"))
((:path . "adnom-poss-mod-possessor-affix-head-final-agr") (:content . "adnom-poss-mod-possessor-affix-head-final-agr: mod-like, possessor affix, head-final, with agr"))
((:path . "adnom-poss-mod-possessor-affix-head-final-agr") (:content . "adnom-poss-mod-possessor-affix-head-final-agr: mod-like, possessor affix, head-final, agr"))
((:path . "adnom-poss-mod-possessor-affix-head-final") (:content . "adnom-poss-mod-possessor-affix-head-final: mod-like, possessor affix, head-final, no agr"))
