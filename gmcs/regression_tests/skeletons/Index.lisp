...
((:path . "clausalmods-wambaya") (:content . "clausalmods-wambaya: illustrative language for clausal modifiers based on wambaya"))
...
((:path . "clausalmods-modifier-position") (:content . "clausalmods-modifier-position: Clausal modifiers that attach before, after or before and after the matrix clause"))
((:path . "clausalmods-mod-position") (:content . "clausalmods-mod-position: Clausal mods test"))
((:path . "clausalmods-mod-position") (:content . "clausalmods-mod-position: Clausal modifiers that attach before, after or before and after the matrix clause"))
((:path . "clausalmods-modifier-position") (:content . "clausalmods-modifier-position: Clausal modifiers that atttach before, after, or before and after the matrix clause"))
((:path . "clausalmods-v2-vfinal-adp") (:content . "clausalmods-v2-vfinal-adp: Clausal modifiers with an adposition (head) subordinator, v2 wo in the main clause and vfinal in the subord clause"))
((:path . "clausalmods-v2-vfinal-adv") (:content . "clausalmods-v2-vfinal-adv: Clausal modifiers with an adverbial subordinator, v2 wo in the main clause and vfinal in the subord clause"))
((:path . "clausalmods-subord-position") (:content . "clausalmods-subord-position: Clausal modifiers witha a free subordinator that attaches that the beginning or end of the subordinate clause"))
((:path . "clausalmods-subord-pairs") (:content . "clausalmods-subord-pairs: Clausal modifiers with subordinator pairs (one in the subord and one in the matrix clause)"))
((:path . "clausalmods-special-morph") (:content . "clausalmods-special-morph: Clausal modifiers that are marked by special verbal morphology"))
((:path . "clausalmods-shared-subject-free-subord") (:content . "clausalmods-shared-subject-free-subord: Clausal modifiers with a free subordinator that share their subject with the matrix verb"))
((:path . "clausalmods-shared-subject-bound-subord") (:content . "clausalmods-shared-subject-bound-subord: Clausal modifiers marked by a bound subordinator morpheme that share their subject with the matrix verb"))
((:path . "clausalmods-morph-and-subord") (:content . "clausalmods-morph-and-subord: Clausal modifiers that have a free subordinator morpheme and also require special morphology in the subordinate clause"))
((:path . "clausalmods-attach-vp-s") (:content . "clausalmods-attach-vp-s: Clausal modifiers that attach to the VP, S or both of the matrix clause"))
((:path . "clausalmods-modifier-position") (:content . "clausalmods-modifier-position: Clausal modifiers that attach before, after or before and after the matrix clause"))
((:path . "clausalmods-modifier-position") (:content . "clausalmods-modifier-position: Clausal modifiers that attach before, after or before and after the matrix clause"))
((:path . "clausalmods-vfinal-v2-adv") (:content . "clausalmods-vfinal-v2-adv: Clausal modifiers with V2 word order in the matrix clause, Vfinal word order in the subordinate clause and and adverbial subordinator"))
((:path . "clausalmods-shared-subject-bound-subord") (:content . "clausalmods-shared-subject-bound-subord: Clausal modifiers with a bound subordinator morpheme that share a subject with the matrix verb"))
((:path . "clausalmods-shared-subject-free-subord") (:content . "clausalmods-shared-subject-free-subord: Clausal modifiers with a free subordinator morpheme that share a subject with the matrix verb"))
...
((:path . "clausalmods-subord-pairs") (:content . "clausalmods-subord-pairs: Clausal Modifiers with subordinator pair"))
((:path . "clausalmods-nom-no-rel") (:content . "clausalmods-nom-no-rel: Clausal modifiers that are nominalized at S (high) but to not have a nominalization predication"))
((:path . "clausalmods-nom-low") (:content . "clausalmods-nom-low: Clausal modifiers that are nominalized at V (low)"))
((:path . "clausalmods-nom-mid") (:content . "clausalmods-nom-mid: Clausal modifiers that are nominalized at VP (mid)"))
((:path . "clausalmods-nom-high") (:content . "clausalmods-nom-high: Clausal modifiers that are nominalized at S (high) and have a nominalization predication"))
