...
def customize_argument_alternation(ch, mylang, lrules, lexicon):
  if ch.get('dative-shift') == 'on':
    customize_dative_shift(ch, mylang, lrules, lexicon)


def customize_dative_shift(ch, mylang, lrules, lexicon):
