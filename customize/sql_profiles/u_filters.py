...
Contents:
    - filter_list - the list of the 16 universal filters
"""
...
filter_list = [IfFilter(name = "uf1", 
               ...
               MatchFilter(name = "uf7",
                           ...
                           comment = "If there are two dets, each one has to be next to its " + \
                                             "associated noun."),
               ...
               IfFilter(name = "uf11",
                        ...
                        comment = "If n2 is the object and it does have a determiner attached to it, " + \
                                          "if there's a p-acc, it has to form a coherent NP with n1 and det."),
