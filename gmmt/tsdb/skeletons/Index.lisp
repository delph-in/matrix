...
(((:path . "epo") (:content . "Espertanto test suite from Ling 567"))
 ...
 ((:path . "eng_mmt") (:content . "English MMT test suite"))
 ((:path . "epo_mmt") (:content . "Esperanto MMT test suite"))
 ((:path . "fas_mmt") (:content . "Farsi MMT test suite"))
 ((:path . "fin_mmt") (:content . "Finnish MMT test suite"))
 ((:path . "hye_mmt") (:content . "Armenian MMT test suite")))
